...
- `docs/parrots/Wayland Compositor.md` - Automat as a Wayland compositor: Hyprland stack, the epoll event loop, protocol surface, GPU buffer passing (dmabuf), input pass-through, window lifetime
