...
#include "base.hpp"
#include "format.hpp"
#include "library_alert.hpp"           // IWYU pragma: keep
#include "library_flip_flop.hpp"       // IWYU pragma: keep
#include "library_hotkey.hpp"          // IWYU pragma: keep
#include "library_increment.hpp"       // IWYU pragma: keep
#include "library_instruction.hpp"     // IWYU pragma: keep
#include "library_key_presser.hpp"     // IWYU pragma: keep
#include "library_macro_recorder.hpp"  // IWYU pragma: keep
#include "library_mouse.hpp"           // IWYU pragma: keep
#include "library_number.hpp"          // IWYU pragma: keep
#include "library_timeline.hpp"        // IWYU pragma: keep
#include "library_timer.hpp"           // IWYU pragma: keep
...
struct ProgressBar : library::Number {
  ProgressBar(ui::Widget* parent) : library::Number(parent) {}
