...
void ShapeWidget::Draw(SkCanvas& canvas, animation::State& animation_state) const {
  DrawColored(canvas, animation_state, paint);
}

void ShapeWidget::DrawColored(SkCanvas& canvas, animation::State&, const SkPaint& paint_arg) const {
