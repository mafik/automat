...
// Declarations here; bodies in ui_leptonica.cc.
...
void DrawPalette(SkCanvas& canvas, const SkRect& r, int selected, slop::State state, uint32_t seed);
...
void DrawModeWheel(SkCanvas& canvas, SkPoint c, float radius, const char* const* labels, int n,
                   int selected, slop::State state, uint32_t seed, const SkPath* glyphs = nullptr);
