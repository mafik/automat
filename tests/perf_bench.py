...
subprocess.run('perf script | grep -v "::_" | sed "s/automat:://; s/gui:://; s/std:://; s/library:://" | third_party/FlameGraph/stackcollapse-perf.pl | third_party/FlameGraph/flamegraph.pl --title "Automat Debug" --cp --colors aqua --inverted --bgcolors blue --width 1890 > build/flamegraph.svg', shell=True, check=True)
